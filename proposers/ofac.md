...
the list is generated automatically from the latest ofac sdn data (`SDN_ENHANCED.ZIP`, published by the us treasury), checked for updates every few minutes. the [ofac-ethereum-addresses](https://github.com/ultrasoundmoney/ofac-ethereum-addresses) repo previously used to track these addresses by hand is archived in favor of the endpoint above.
